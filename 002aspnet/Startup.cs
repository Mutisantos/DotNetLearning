    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<EscuelaContext>(
                //Use this configuration to use a InMemory Database
                // options => options.UseInMemoryDatabase(databaseName: "localTest-db")
                //Use this to connect to the SQL Server local instance
